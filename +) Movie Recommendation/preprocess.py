''' 
Codes to read a .dat file 

Information about the data file
rating.dat: UserID::MovieID::Rating::Timestamp
	UserID: range between 1 and 6040
	MovieID: range between 1 and 3952
	Rating: 5 star scale (whole start only)
	Timestamp: seconds
...
#Generate one-epoch batches - for test data 
class OneEpochIterator(ShuffleIterator):
	def __init__(self, inputs, batch_size=10):
		super(OneEpochIterator, self).__init(inputs, batch_size=batch_size)
		if batch_size > 0: 
